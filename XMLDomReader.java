            ...
            for( int i = 0; i < accounts.getLength(); i++ ) {
                ...
                if(type.getNodeType() == Node.ELEMENT_NODE){
                    ...
                    if(name=="creditCardAccount"){
                        ...
                        System.out.println(name+": "+"creditCardNumber: "+creditCardNumber+", expirationDate: "+expirationDate+", Issuer: "+issuer+", amount: "+amount);
                        ...
                        System.out.println(name+": bankAccountType: "+accountType+", lenderName: "+lenderName+", amount: "+amount);
                    } else {
                        Element des = (Element)description.item(0);
                        String accountType = des.getElementsByTagName("accountType").item(0).getTextContent();
                        String lenderName = des.getElementsByTagName("lenderName").item(0).getTextContent();
                        System.out.println(name+": lenderName: "+lenderName+", accountType: "+accountType+", amount: "+amount);
                    }
                }
            }
